defmodule Test1Web.EventControllerTest do
  ...
  @create_attrs %{address: "some address", city: "some city", cover: "some cover", date: ~N[2010-04-17 14:00:00], description: "some description", link: "some link", title: "some title"}
